...
const sendVerificationEmail = async (userEmail, otp, username) => {
  ...
  try {
    ...
    const mailOptions = {
      from: `Mero Kharcha <${myEmail}>`, // ✅ fixed: template literal so your real email shows
      to: userEmail,
      subject: `${otp} is your Mero Kharcha ${username ? "account verification code" : "account recovery code"}`,
      html: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body>
          <div class="container">
              ...
              <div class="content">
                  ...
                  <p>Please use the following OTP ${username ? "to verify your account" : "to reset your password"}:</p>
    ...
    console.log("✅ Email with OTP sent successfully to:", userEmail);
  } catch (error) {
