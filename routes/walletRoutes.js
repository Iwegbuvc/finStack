const { getDepositAddress, initiateWithdrawal, submitPaycrestWithdrawal, getDashboardBalances, submitCryptoWithdrawal} = require("../controllers/walletController");
...
router.post("/withdraw/complete", verifyToken,transactionLimiter,submitPaycrestWithdrawal);
// CRYPTO WITHDRAWAL ROUTE
router.post("/withdraw/cryptoComplete", verifyToken, transactionLimiter, submitCryptoWithdrawal);
