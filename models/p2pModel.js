...
const P2PTradeSchema = new mongoose.Schema({
    ...
    provider: {type: String, enum: ["9PSB", "BLOCKRADER"],required: true,},
    rate: { type: Number, required: true },
    currencySource: { type: String, enum: ["NGN", "USD", "GHS", "XAF", "XOF", "RMB"], required: true },
    currencyTarget: { type: String, enum: ["NGN", "USD"], required: true },
